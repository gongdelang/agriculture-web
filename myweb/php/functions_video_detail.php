...
function open($form,$id){
	...
	$video.="<source src='".$row["video"]."' type='video/mp4'>";
	$video.="<object data='".$row["video"]."' width='960' height='550'>";
	$video.="<embed src='".$row["video"]."' width='960' height='550'>";
