...
function  fengye($form,$page){
	...
	$li.="</ul>";
	if($form=="information-market"){
		$url="http://www.xjxnw.gov.cn/sc/jgxq";
		$li="<p class='other'>以下信息来源于：<a target='_blank' href='http://www.xjxnw.gov.cn/sc/jgxq'>兴农网</a></p>";
		$li.="<div style='margin:10px auto;width:750px;height:1020px;position:relative;overflow:hidden;'>";	
		if(varify_url($url)){   
			$li.="<iframe src='http://www.xjxnw.gov.cn/sc/jgxq' width='1370' height='1700' frameborder='0' scrolling='no' style='position:absolute; top:-720px; left:-182px; '></iframe>";
		}
		else{   
			$li.="<a href='http://www.xjxnw.gov.cn/sc/jgxq'><img src='../css/tips_picture/market_mingxi.jpg' width='750' height='1020'></a>";   
		}  
		$li.="</div>";
	}
	echo $li;
