...
//------------------------------------------------------------------
	...
	for($i=1;$i<39;++$i){
		switch($i){
			case 1:$form=$sql_news_hot;$module="information";$tip="热门新闻";$search_data=search_form_information($form,$search);break;
			case 2:$form=$sql_news_new;$module="information";$tip="最新新闻";$search_data=search_form_information($form,$search);break;

			case 3:$form=$sql_policy_dongtai;$module="information";$tip="政策动态";$search_data=search_form_information($form,$search);break;
			case 4:$form=$sql_policy_huinong;$module="information";$tip="惠农政策";$search_data=search_form_information($form,$search);break;
			case 5:$form=$sql_policy_biaozhun;$module="information";$tip="农业标准";$search_data=search_form_information($form,$search);break;

			case 6:$form=$sql_market_dongtai;$module="information";$tip="行情动态";$search_data=search_form_information($form,$search);break;

			case 7:$form=$sql_video_hot;$module="video";$tip="热门视频";$search_data=search_form_information($form,$search);break;
			case 8:$form=$sql_video_zhongzhi;$module="video";$tip="种植视频";$search_data=search_form_information($form,$search);break;
			case 9:$form=$sql_video_xinxi;$module="video";$tip="作物信息";$search_data=search_form_information($form,$search);break;
			case 10:$form=$sql_video_sannong;$module="video";$tip="三农政策";$search_data=search_form_information($form,$search);break;

			case 11:$form=$sql_teach_guaguo;$module="teach";$tip="瓜果";$search_data=search_form_information($form,$search);break;
			case 12:$form=$sql_teach_shucai;$module="teach";$tip="蔬菜";$search_data=search_form_information($form,$search);break;
			case 13:$form=$sql_teach_tree;$module="teach";$tip="果树";$search_data=search_form_information($form,$search);break;
			case 14:$form=$sql_teach_funguns;$module="teach";$tip="食用菌";$search_data=search_form_information($form,$search);break;
			case 15:$form=$sql_teach_foodcrop;$module="teach";$tip="粮食作物";$search_data=search_form_information($form,$search);break;
			case 16:$form=$sql_teach_cashcrop;$module="teach";$tip="经济作物";$search_data=search_form_information($form,$search);break;

			case 17:$form=$sql_nongzi_nongyao_shachongji;$module="nongzi";$tip="杀虫剂";$search_data=search_form_nongzi($form,$search);break;
			case 18:$search_data=$form=$sql_nongzi_nongyao_shajunji;$module="nongzi";$tip="杀菌剂";$search_data=search_form_nongzi($form,$search);break;
			case 19:$form=$sql_nongzi_nongyao_chucaoji;$module="nongzi";$tip="除草剂";$search_data=search_form_nongzi($form,$search);break;
			case 20:$form=$sql_nongzi_nongyao_tiaojieji;$module="nongzi";$tip="调节剂";$search_data=search_form_nongzi($form,$search);break;

			case 21:$form=$sql_nongzi_huafei_fuhe;$module="nongzi";$tip="复合肥";$search_data=search_form_nongzi($form,$search);break;
			case 22:$form=$sql_nongzi_huafei_shenwu;$module="nongzi";$tip="生物肥";$search_data=search_form_nongzi($form,$search);break;
			case 23:$form=$sql_nongzi_huafei_jia;$module="nongzi";$tip="钾肥";$search_data=search_form_nongzi($form,$search);break;
			case 24:$form=$sql_nongzi_huafei_youji;$module="nongzi";$tip="有机肥";$search_data=search_form_nongzi($form,$search);break;

			case 25:$form=$sql_nongzi_zhongzi_datian;$module="nongzi";$tip="大田种子";$search_data=search_form_nongzi($form,$search);break;
			case 26:$form=$sql_nongzi_zhongzi_guaguo;$module="nongzi";$tip="瓜果种子";$search_data=search_form_nongzi($form,$search);break;
			case 27:$form=$sql_nongzi_zhongzi_shucai;$module="nongzi";$tip="蔬菜种子";$search_data=search_form_nongzi($form,$search);break;

			case 28:$form=$sql_nongzi_jixie_yunshu;$module="nongzi";$tip="运输";$search_data=search_form_nongzi($form,$search);break;
			case 29:$form=$sql_nongzi_jixie_jiagong;$module="nongzi";$tip="加工";$search_data=search_form_nongzi($form,$search);break;
			case 30:$form=$sql_nongzi_jixie_caishou;$module="nongzi";$tip="采收";$search_data=search_form_nongzi($form,$search);break;

			case 31:$form=$sql_illness_guaguo;$module="bing_chong";$tip="瓜果病害";$search_data=search_form_information($form,$search);break;
			case 32:$form=$sql_illness_shucai;$module="bing_chong";$tip="蔬菜病害";$search_data=search_form_information($form,$search);break;
			case 33:$form=$sql_illness_tree;$module="bing_chong";$tip="果树病害";$search_data=search_form_information($form,$search);break;
			case 34:$form=$sql_illness_datian;$module="bing_chong";$tip="大田病害";$search_data=search_form_information($form,$search);break;

			case 35:$form=$sql_wrom_guaguo;$module="bing_chong";$tip="瓜果虫害";$search_data=search_form_information($form,$search);break;
			case 36:$form=$sql_wrom_shucai;$module="bing_chong";$tip="蔬菜虫害";$search_data=search_form_information($form,$search);break;
			case 37:$form=$sql_wrom_tree;$module="bing_chong";$tip="果树虫害";$search_data=search_form_information($form,$search);break;
			case 38:$form=$sql_wrom_datian;$module="bing_chong";$tip="大田虫害";$search_data=search_form_information($form,$search);break;

			default:$form=$sql_news_hot;$module="information";$tip="最新新闻";$search_data=search_form_information($form,$search);break;
		}
		//搜索数据
