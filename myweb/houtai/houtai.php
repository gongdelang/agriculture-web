...
<?php include("php/functions_houtai.php") ?><!--首页-函数库-->
<!--js样式star-->
			...
			<!--标题导航end-->
				<!--搜索出的内容_content star-->
					<div class="title">
							...
							<a id='tianjia' href='houtai_detail?form=<?php echo $form ?>&module=<?php echo $module ?>'>添加数据</a>
					</div>
					<div class="content">
						<!--表界面-->
						<?php all_enty($form,$page,$module); ?>
						<script>
							$(function(){
								$(".content .shanchu").click(function(){
									var msg = "您真的确定要删除吗？\n\n请确认！";
									if (confirm(msg)==true){
										return true;
									}
