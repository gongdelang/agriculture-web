...
function titile($form,$id,$page){
	...
	$div.="<a href='../../houtai.php'>后台管理></a><a href='bing_chong.php?form=1'>病虫害防治></a>";
	switch($form){
...
function detail($form,$id,$page){
	...
	$div.="</p>";
	//图片
	$div.="<div style='text-align: center; margin-top:20px;'><img alt='图片' width='710' height='411' src='../../bing_chong/";
	$div.=$row["picture"];
