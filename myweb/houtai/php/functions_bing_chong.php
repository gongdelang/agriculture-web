...
function titile($form){
	...
	$div.="<a href='../houtai.php' target='_blank'>后台管理></a><span>病虫害防治></span>";
	switch($form){
...
function  fengye($form,$page){
	...
	while($row=mysql_fetch_array($result)){
			...
			$li.=$row["id"];
			$li.="' target='_blank'><img src='../../bing_chong/";
			$li.=$row["picture"];
			$li.="'></a>";
			//-----------------------------------------------------
			...
			$li.="</p>";
				...
				$li.="<a id='shanchu' href='../shanchu.php?form=".$form."&id=".$row["id"]."'>删除</a>";
					$li.="<a class='xiugai' href='../houtai_detail.php?form=".$form."&id=".$row["id"]."&module=bing_chong' target='_balnk'>修改</a>";
